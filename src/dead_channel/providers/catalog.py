...
_PERPLEXITY_CATALOG: Final = (
    ModelInfo(id="perplexity:sonar", provider="perplexity", context=128_000),
    ModelInfo(id="perplexity:sonar-pro", provider="perplexity", context=200_000),
    ModelInfo(id="perplexity:sonar-reasoning", provider="perplexity", context=128_000),
    ModelInfo(id="perplexity:sonar-reasoning-pro", provider="perplexity", context=128_000),
    ModelInfo(id="perplexity:sonar-deep-research", provider="perplexity", context=128_000),
)
